...
static const char *fonts[]          = { "JetBrainsMono:size=17", "fontawesome:size=17" };
static const char dmenufont[]       = "JetBrainsMono:size=17";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-l", "10" };
static const char *termcmd[]  = { "st", NULL };
static const char *mutecmd[] = { "volume.sh", "mute", NULL };
...
static const char *sxivcmd[] = { "s", NULL };
